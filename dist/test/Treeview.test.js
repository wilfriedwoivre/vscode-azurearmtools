...
suite("TreeView", () => __awaiter(this, void 0, void 0, function* () {
    suite("shortenTreeLabel", () => __awaiter(this, void 0, void 0, function* () {
        test("shortenTreeLabel", () => {
            function testShorten(label, expected) {
                let shortenedLabel = extension_bundle_1.shortenTreeLabel(label);
    ...
    suite("JsonOutlineProvider", () => __awaiter(this, void 0, void 0, function* () {
        let provider;
        setup(function (done) {
            this.timeout(15000);
            function mySetup() {
                return __awaiter(this, void 0, void 0, function* () {
                    let extension = vscode.extensions.getExtension(extension_bundle_1.ext.extensionId);
                    assert.equal(!!extension, true, "Extension not found");
                    yield extension.activate();
                    provider = extension_bundle_1.ext.jsonOutlineProvider;
                    assert.equal(!!provider, true, "JSON outline provider not found");
                });
            }
            mySetup().then(done, (err) => {
                assert.fail(`Setup failed: ${vscode_azureextensionui_1.parseError(err).message}`);
            });
        });
        function testChildren(template, expected) {
            return __awaiter(this, void 0, void 0, function* () {
                yield showNewTextDocument(template);
        ...
        function testTree(template, expected, selectProperties) {
            return __awaiter(this, void 0, void 0, function* () {
                yield showNewTextDocument(template);
        ...
        function treeMap(tree, visit) {
            let newTree = tree.map(node => {
        ...
        function testLabels(template, expected) {
            return __awaiter(this, void 0, void 0, function* () {
                yield testTree(template, expected, ["label"]);
            });
        }
        ...
        /////////////////////////
        test("getChildren: Top level: all default param types", () => __awaiter(this, void 0, void 0, function* () {
            yield testChildren(templateAllParamDefaultTypes, [
                {
        ...
        /////////////////////////
        test("getLabel: displayName tag overrides name", () => __awaiter(this, void 0, void 0, function* () {
            yield testLabels(`{
        ...
        /////////////////////////
        test("getChildren: Full tree: all default param types", () => __awaiter(this, void 0, void 0, function* () {
            yield testTree(templateAllParamDefaultTypes, [
                {
                    label: "$schema: http://schema.management.azure.com/schemas/2015-01-01/deploymentTemplate.json#",
                    collapsibleState: 0,
                    icon: "label.svg"
        ...
        /////////////////////////
        test("getChildren: Full tree: VN Gateway", () => __awaiter(this, void 0, void 0, function* () {
            const templateVNGateway = `
                {
                    "$schema": "http://schema.management.azure.com/schemas/2015-01-01/deploymentTemplate.json#",
                    "contentVersion": "1.0.0.0",
                    "resources": [
                ...
                `;
            yield testTree(templateVNGateway, [
                {
                    label: "$schema: http://schema.management.azure.com/schemas/2015-01-01/deploymentTemplate.json#",
                    collapsibleState: 0,
                    icon: "label.svg"
        ...
        /////////////////////////
        test("getChildren: Full tree: New VM", () => __awaiter(this, void 0, void 0, function* () {
            const templateNewVM = `
                {
                    "$schema": "http://schema.management.azure.com/schemas/2015-01-01/deploymentTemplate.json#",
                    "contentVersion": "1.0.0.0",
        ...
        /////////////////////////
        test("getChildren: Errors: Bad key type", () => __awaiter(this, void 0, void 0, function* () {
            yield testTree(`{
                "$schema": "https://schema.management.azure.com/schemas/2015-01-01/deploymentTemplate.json#",
                true: false
            }`, [
        ...
        /////////////////////////
        test("getChildren: Errors: Missing end quote", () => __awaiter(this, void 0, void 0, function* () {
            yield testTree(`{
                {
                    "$schema": "https://schema.management.azure.com/schemas/2015-01-01/deploymentTemplate.json#",
                    "true: false
...
function showNewTextDocument(text) {
    return __awaiter(this, void 0, void 0, function* () {
        let textDocument = yield vscode.workspace.openTextDocument({
            language: "jsonc",
            content: text
        });
...
const templateAllParamDefaultTypes = `
            {
                "$schema": "http://schema.management.azure.com/schemas/2015-01-01/deploymentTemplate.json#",
                    "contentVersion": "1.0.0.0",
                        "a": 1,
